...
pub fn load_game_object_animations(asset_server: AssetServer) -> HashMap<GameObjectType, AnimationState>  {
  let game_object_animations: HashMap<GameObjectType, AnimationState> = HashMap::from([
    ...
    (GameObjectType::RaphaelleAura,                    AnimationState::new(vec![asset_server.load("characters/raphaelle/textures/secondary.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    ...
    (GameObjectType::HernaniBullet,                    AnimationState::new(vec![asset_server.load("characters/hernani/textures/bullet.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::RaphaelleBullet,                  AnimationState::new(vec![asset_server.load("characters/raphaelle/textures/bullet.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::RaphaelleBulletEmpowered,         AnimationState::new(vec![asset_server.load("characters/raphaelle/textures/bullet-empowered.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::CynewynnSword,                    AnimationState::new(vec![asset_server.load("characters/cynewynn/textures/bullet.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::HernaniLandmine,                  AnimationState::new(vec![asset_server.load("characters/hernani/textures/trap.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::FedyaProjectileRicochet,          AnimationState::new(vec![asset_server.load("characters/hernani/textures/bullet.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::FedyaProjectileGround,            AnimationState::new(vec![asset_server.load("characters/hernani/textures/trap.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::FedyaProjectileGroundRecalled,    AnimationState::new(vec![asset_server.load("characters/hernani/textures/trap.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::FedyaTurret,                      AnimationState::new(vec![asset_server.load("ui/temp_ability_1.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::FedyaTurretProjectile,            AnimationState::new(vec![asset_server.load("characters/hernani/textures/bullet.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    ...
    (GameObjectType::CenterOrbSpawnPoint,              AnimationState::new(vec![asset_server.load("empty.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::WiroShield,                       AnimationState::new(vec![asset_server.load("ui/temp_ability_1.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::WiroGunShot,                      AnimationState::new(vec![asset_server.load("ui/temp_ability_1.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::WiroDashProjectile,               AnimationState::new(vec![asset_server.load("empty.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::TemerityRocket,                   AnimationState::new(vec![asset_server.load("ui/temp_ability_1.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::TemerityRocketSecondary,          AnimationState::new(vec![asset_server.load("ui/temp_ability_1.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::KoldoCannonBall,                  AnimationState::new(vec![asset_server.load("characters/raphaelle/textures/bullet.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::KoldoCannonBallEmpowered,         AnimationState::new(vec![asset_server.load("characters/raphaelle/textures/bullet-empowered.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
    (GameObjectType::KoldoCannonBallEmpoweredUltimate, AnimationState::new(vec![asset_server.load("characters/raphaelle/textures/bullet-empowered.png")],Vec2 {x: 200.0, y: 400.0},1.0, 0)),
  ]);

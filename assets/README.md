...
Raphaelle is an Archangel and a combat medic, but over her many battles had come to enjoy the "combat" part of medic, learning fighting skills from Wiro and tying them with her healing magic, creating a hybrid fighting style. Some Angels are concerned she might be enjoying combat a bit more than a sworn pacifist should, but she remains a valuable asset.
...
Morana finds anyone near their death and isolates them from the imminent cause. She temporarily heals them, wards off threats, or does whatever necessary so she may comfort them in their final moments, delaying their death, but never saving them. In this transition period with her, some people tell her the story of their life, some people listen to her as she comfort them, others rather sit in silence with her at her side, and some may rest in her arms. Only once they are entirely lulled either into acceptance or oblivion she strikes swiftly, making the journey from this world as pleasant as the journey into it. She wears a mask, only showing her face to those who won't tell the tale. She is very much a mortal herself and used to be a Seraphim, interpreting her job as a holy mission. NOTES: This character should always be represented as a positive, but unstoppable force. Her work is endorsed by God, who reassures her that despite not knowing what lies after death, it is beautiful, and should not be feared.